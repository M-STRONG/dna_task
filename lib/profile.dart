...
class _profileState extends State<profile> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          title: Text("dev_mxhmd", style: TextStyle(color: Colors.black)),
          leading: Icon(
